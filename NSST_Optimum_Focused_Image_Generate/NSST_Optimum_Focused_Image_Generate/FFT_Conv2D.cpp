...
/// </returns>
Matrix* FFTConv2D(const Matrix* image, const Matrix* kernel, const char* shape) {

	Output* outputs = ProcessInputs(image->mat, image->width, image->height, kernel->mat, kernel->width, kernel->height, shape);
